...
namespace NextStop.Tests.Dal.Ado;

public class AdoHolidayDaoTests : IDisposable
{
    ...
    public AdoHolidayDaoTests()
    {
        configuration = ConfigurationUtil.GetConfiguration();
        holidayTableName = configuration["HolidayTableName"];
        ...
        createTable();
        _sut = new AdoHolidayDao(connectionFactory, holidayTableName);
    }
